...
public class Funcionario  implements java.io.Serializable {
    ...
    public Funcionario(int idfuncionario, String nome, String username, short password, Date datanascimento, char sexo, boolean activo, boolean tipo, String morada) {
    ...
    public Funcionario(int idfuncionario, Horario horario, Localtrabalho localtrabalho, String nome, String username, short password, Date datanascimento, char sexo, boolean activo, boolean tipo, String morada, Set<Entrega> entregasForIdfuncionarioentrega, Set<Entrega> entregasForIdfuncionariorecebe, Set<Venda> vendas, Set<Pontohorario> pontohorarios) {
       this.idfuncionario = idfuncionario;
